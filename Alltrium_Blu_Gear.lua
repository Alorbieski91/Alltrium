function user_job_setup()
	...
	state.WeaponskillMode:options('Match','AtkCapped','Normal','Acc','FullAcc','Fodder')
...
function init_gear_sets()
	...
	sets.precast.WS.FullAcc = {ammo="Coiste Bodhar",
		head="Carmine Mask +1",neck="Mirage Stole",ear1="Mache Earring +1",ear2="Odr Earring",
	...
	sets.precast.WS.Fodder = {ammo="Aurgelmir Orb +1",
		...
		body="Adhemar Jacket +1",hands="Jhakri Cuffs +2",ring1="Epona's Ring",ring2="Rufescent Ring",
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Coiste Bodhar",
		...
		body="Gleti's Cuirass",hands="Adhemar Wrist. +1",ring1="Begrudging Ring",ring2="Epona's Ring",
	...
	sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {ammo="Coiste Bodhar",
		head=gear.herculean_wsd_head,neck="Mirage Stole",ear1="Ishvara Earring",ear2="Moonshade Earring",
		body="Assim. Jubbah +2",hands="Jhakri Cuffs +2",ring1="Karieyh Ring",ring2="Rufescent Ring",
		back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs=gear.herculean_wsd_legs,feet="Jhakri Pigaches +2"})

	sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Coiste Bodhar",
		head=gear.herculean_wsd_head,neck="Mirage Stole",ear1="Ishvara Earring",ear2="Moonshade Earring",
		body="Assim. Jubbah +2",hands="Jhakri Cuffs +2",ring1="Karieyh Ring",ring2="Rufescent Ring",
	...
	sets.precast.WS['Savage Blade'].AtkCapped = set_combine(sets.precast.WS['Savage Blade'], {head="Gleti's Mask",body="Gleti's Cuirass",hands="Jhakri Cuffs +2",legs="Gleti's Breeches",feet="Gleti's Boots"})
	...
	sets.precast.WS['Expiacion'].AtkCapped = set_combine(sets.precast.WS['Expiacion'], {head="Gleti's Mask",body="Gleti's Cuirass",hands="Jhakri Cuffs +2",legs="Gleti's Breeches",feet="Gleti's Boots"})
	...
	sets.midcast['Blue Magic'].Physical = {main="Vampirism",sub="Vampirism",ammo="Mavi Tathlum",
		head="Lilitu Headpiece",neck="Mirage Stole",ear1="Suppanomimi",ear2="Telos Earring",
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Sequence",sub="Almace",ammo="Coiste Bodhar",
	...
	sets.midcast['Blue Magic'].Physical.Fodder = {main="Iris",sub="Iris",ammo="Mavi Tathlum",
		head="Luh. Keffiyeh +1",neck="Mirage Stole",ear1="Suppanomimi",ear2="Telos Earring",
	...
	sets.midcast['Blue Magic'].PhysicalAcc = {main="Sequence",sub="Almace",ammo="Coiste Bodhar",
		head="Jhakri Coronal +2",neck="Mirage Stole",ear1="Regal Earring",ear2="Telos Earring",
	...
	sets.midcast['Blue Magic'].MagicAccuracy = {main="Iris",sub="Iris",ammo="Pemphredo Tathlum",
		head="Jhakri Coronal +2",neck="Mirage Stole",ear1="Digni. Earring",ear2="Njordr Earring",
	...
	sets.midcast['Enfeebling Magic'] = {ammo="Pemphredo Tathlum",
		head="Jhakri Coronal +2",neck="Sanctity Necklace",ear1="Digni. Earring",ear2="Friomisi Earring",
		body="Jhakri Robe +2",hands="Jhakri Cuffs +2",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
	...
	sets.midcast.Cure = {ammo="Coiste Bodhar",
		head="Jhakri Coronal +2",neck="Sanctity Necklace",ear1="Hecate's Earring",ear2="Mendi. Earring",
	...
	sets.midcast['Blue Magic'].Breath = {ammo="Mavi Tathlum",
		head="Luh. Keffiyeh +1",neck="Mirage Stole",ear1="Regal Earring",ear2="Digni. Earring",
	...
	sets.midcast['Blue Magic'].Stun.Resistant = {main="Iris",sub="Iris",ammo="Coiste Bodhar",
		head="Malignance Chapeau",neck="Mirage Stole",ear1="Regal Earring",ear2="Digni. Earring",
		body="Nyame Mail",hands="Malignance Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back="Cornflower Cape",waist="Sacro Cord",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.midcast['Blue Magic'].Healing = {ammo="Staunch Tathlum",
		...
		body=gear.telchine_whitewind_body,hands=gear.telchine_whitewind_hands,ring1="Kunaji Ring",ring2="Meridian Ring",
		back=gear.nuke_jse_back,waist="Sacro Cord",legs=gear.telchine_whitewind_legs,feet=gear.telchine_whitewind_feet}

	--Overwrite certain spells with these peices even if the day matches, because of resource inconsistancies.
	sets.NonElementalCure = {back="Tempered Cape +1",waist="Luminary Sash"}

	sets.midcast['Blue Magic'].SkillBasedBuff = {ammo="Mavi Tathlum",
		head="Telchine Cap",neck="Mirage Stole",ear1="Ethereal Earring",ear2="Njordr Earring",
		body="Assim. Jubbah +2",hands="Jhakri Cuffs +2",ring1="Defending Ring",ring2="Stikini Ring",
	...
	sets.midcast['Blue Magic'].Buff = {ammo="Mavi Tathlum",
		head="Telchine Cap",neck="Mirage Stole",ear1="Ethereal Earring",ear2="Njordr Earring",
		body="Assim. Jubbah +2",hands="Telchine Gloves",ring1="Defending Ring",ring2="Stikini Ring",
	...
	sets.idle.DTHippo = set_combine(sets.idle.PDT, {head="Malignance Chapeau",body="Malignance Tabard",hands="Malignance Gloves",legs="Carmine Cuisses +1",feet="Malignance Boots"})
	...
	sets.engaged.Acc.DT = {main="Tizona",sub="Almace",ammo="Coiste Bodhar",
	...
	sets.engaged.Acc.DT.AM = {main="Tizona",sub="Almace",ammo="Coiste Bodhar",
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Digni. Earring",ear2="Telos Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ilabrat Ring",
		back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.FullAcc.DT = {main="Tizona",sub="Almace",ammo="Coiste Bodhar",
